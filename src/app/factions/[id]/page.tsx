...
/**
 * @deprecated - This page should be migrated to frontend-next/src/app/factions/[id]/page.tsx
 * This is a temporary wrapper during migration
 */
import { notFound } from 'next/navigation';
import Image from 'next/image';
import { fetchFactionById, getFactionIds } from 'frontend-next/src/services/factionService';
import { Badge } from '@/components/ui/badge';
import { Card, CardContent } from '@/components/ui/card';
...
export async function generateStaticParams() {
  ...
  // Use the frontend-next service
  const factionResponse = await fetchFactionById(params.id);
