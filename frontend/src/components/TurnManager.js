  ...
  return (
    <div className="turn-manager h-full flex flex-col space-y-4">
      ...
      <div className="text-center border-b border-cyan-400/30 pb-4">
        <div className="text-2xl font-bold text-cyan-400 font-mono">TURN {currentTurn}</div>
        <div className="text-sm text-gray-400 mt-1">Crisis Unleashed Protocol</div>
      </div>

      {/* Active Player Indicator */}
      <div className="space-y-3">
        <div className="text-sm font-mono text-gray-400 text-center">ACTIVE COMMANDER</div>
      ...
      <div className="space-y-2">
        <div className="text-sm font-mono text-gray-400 text-center">COMBAT PHASE</div>
        ...
        <div className="mt-auto pt-4">
          <button
            ...
            className="w-full py-3 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-500 hover:to-red-500 
                     ...
                     active:scale-95"
          >
            <div className="font-mono text-sm">END TURN</div>
          </button>
        </div>
      )}
      ...
      <div className="space-y-2 pt-4 border-t border-cyan-400/30">
        <div className="text-xs font-mono text-gray-400 text-center">SYSTEM STATUS</div>
