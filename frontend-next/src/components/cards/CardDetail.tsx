...
export const CardDetail: React.FC<CardDetailProps> = ({
  ...
  return (
    ...
    >
      <div
        className={cn("p-6 relative", getFactionGradientClass(card.faction))}
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-6">
          ...
          <div className="w-full md:w-2/3 text-white">
            <div className="flex items-center gap-2 mb-2">
              ...
              <Badge className={cn("text-black", rarityColors[card.rarity])}>
                {card.rarity}
              </Badge>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300 mb-4">
                This card works well with other {card.faction} cards that focus
                on
                {card.keywords?.includes("Quick Attack") &&
                  " quick attacks and initiative control"}
                {card.keywords?.includes("Overwhelm") &&
                  " overwhelming the opponent's defenses"}
              ...
              <p className="text-sm text-gray-300">
                ...
                {card.type === "unit" &&
                  " removal spells and high attack units"}
                {card.type === "action" &&
                  " counter spells and anticipatory play"}
        ...
        <TabsContent value="lore" className="p-6">
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300">
                As a {card.faction} card, {card.name} embodies the
                faction&apos;s principles of
                {card.faction === "solaris" &&
                  " light, energy, and direct power."}
                {card.faction === "umbral" &&
                  " shadow, stealth, and manipulation."}
                {card.faction === "aeonic" &&
                  " time, control, and strategic foresight."}
                {card.faction === "primordial" &&
                  " nature, growth, and adaptation."}
                {card.faction === "infernal" &&
                  " fire, destruction, and overwhelming force."}
                {card.faction === "neuralis" &&
                  " mind, technology, and analytical precision."}
                {card.faction === "synthetic" &&
                  " artificial intelligence, adaptation, and optimization."}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-300">
                This card represents an important element in the Crisis
                Unleashed universe, showing the
                {card.type === "hero" &&
                  " legendary heroes who lead their factions into battle."}
                {card.type === "unit" &&
                  " diverse forces that fight for their faction's cause."}
                {card.type === "action" &&
                  " tactical abilities and strategic options available."}
                {card.type === "structure" &&
                  " permanent structures that shape the battlefield."}
              </p>
            </div>
          </div>
        </TabsContent>
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
              <div>
                ...
                <p className="text-sm text-gray-300">
                  You own{" "}
                  <span className="font-bold text-white">{ownedQuantity}</span>{" "}
                  copies of this card.
                </p>
              </div>
