      ...
      <CardHeader>
        <div className="flex justify-between items-start">
          ...
          <Badge 
            ...
            className={isValid ? "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400" : ""}
          >
      ...
      <CardContent className="p-0">
        ...
        {deck.cards.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 px-6 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-1">Empty Deck</h3>
