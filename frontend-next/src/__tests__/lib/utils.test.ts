...
describe("Utility Functions", () => {
  ...
  describe("getFactionColorClass", () => {
    it("returns the correct color class for known factions", () => {
      expect(getFactionColorClass("solaris")).toBe(
        "text-faction-solaris-primary",
      );
      expect(getFactionColorClass("umbral")).toBe(
        "text-faction-umbral-primary",
      );
      expect(getFactionColorClass("synthetic")).toBe(
        "text-faction-synthetic-primary",
      );
    });
  ...
  describe("getFactionGradientClass", () => {
    it("returns the correct gradient class for known factions", () => {
      expect(getFactionGradientClass("solaris")).toBe(
        "faction-gradient-solaris",
      );
      expect(getFactionGradientClass("umbral")).toBe("faction-gradient-umbral");
      expect(getFactionGradientClass("neuralis")).toBe(
        "faction-gradient-neuralis",
      );
    });
