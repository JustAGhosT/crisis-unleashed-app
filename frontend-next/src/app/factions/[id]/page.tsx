...
export default async function FactionPage({ params }: { params: { id: string } }) {
    ...
    <div className="container mx-auto py-8">
      ...
      <div className="relative h-80 w-full mb-8 rounded-lg overflow-hidden">
        ...
        <div className="absolute bottom-6 left-6 flex items-center">
          <div className={`p-2 rounded-full mr-4 ${bgColorClass} bg-opacity-20 dark:bg-opacity-30`}>
            <Image
              src={`/images/factions/${faction.id}-logo.svg`}
              alt={`${faction.name} logo`}
              width={80}
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <Link href="/factions">
            <Button variant="outline" className="dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800">
              ← Back to Factions
            </Button>
          </Link>
        </div>
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="w-full justify-start mb-6 dark:bg-gray-800">
          ...
          <TabsTrigger value="strategy" className="dark:data-[state=active]:bg-gray-700">Strategy</TabsTrigger>
          <TabsTrigger value="cards" className="dark:data-[state=active]:bg-gray-700">Cards</TabsTrigger>
          <TabsTrigger value="lore" className="dark:data-[state=active]:bg-gray-700">Lore</TabsTrigger>
        </TabsList>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              <Card className="dark:bg-gray-800 dark:border-gray-700">
                <CardContent className="pt-6">
                  <h2 className="text-2xl font-semibold mb-4 dark:text-white">Faction Overview</h2>
                  <p className="text-lg mb-6 dark:text-gray-300">{faction.description}</p>
                  
                  <h3 className="text-xl font-semibold mb-3 dark:text-white">Key Mechanics</h3>
                  <div className="flex flex-wrap gap-2 mb-6">
                    {Object.keys(faction.mechanics ?? {}).map((mechanic) => (
                      <Badge 
                        key={mechanic} 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h3 className="text-xl font-semibold mb-3 dark:text-white">Philosophy</h3>
                      <p className="dark:text-gray-300">{faction.philosophy}</p>
                    </div>
                    <div>
                      <h3 className="text-xl font-semibold mb-3 dark:text-white">Strengths</h3>
            ...
            <div>
              <Card className="dark:bg-gray-800 dark:border-gray-700">
                <CardContent className="pt-6">
                  <h2 className="text-2xl font-semibold mb-4 dark:text-white">Faction Details</h2>
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-sm font-medium dark:text-gray-400">Faction Color</h3>
                      <div className="mt-1 flex items-center">
                        <div
                          className={`h-6 w-6 rounded-full mr-2 border ${bgColorClass}`}
                        />
                        <span className="dark:text-white">{faction.colors.primary}</span>
                      </div>
                    </div>
                    <div>
                      <h3 className="text-sm font-medium dark:text-gray-400">Play Style</h3>
                      <p className="mt-1 dark:text-white">{playStyle}</p>
                    </div>
                    <div>
                      <h3 className="text-sm font-medium dark:text-gray-400">Difficulty</h3>
                      <p className="mt-1 dark:text-white">{difficulty}</p>
                    </div>
                    <div>
                      <h3 className="text-sm font-medium dark:text-gray-400">Synergies</h3>
                      <p className="mt-1 dark:text-white">{synergy}</p>
                    </div>
                    <div>
                      <h3 className="text-sm font-medium dark:text-gray-400">Technology</h3>
                      <p className="mt-1 dark:text-white">{faction.technology}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
        ...
        <TabsContent value="strategy">
          <Card className="dark:bg-gray-800 dark:border-gray-700">
            <CardContent className="pt-6">
              <h2 className="text-2xl font-semibold mb-4 dark:text-white">Strategy Guide</h2>
              <div className="space-y-6 dark:text-gray-300">
                ...
                <p>
                  In the late game, your powerful faction-specific cards can turn the tide of battle when played strategically.
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="cards">
          <Card className="dark:bg-gray-800 dark:border-gray-700">
            <CardContent className="pt-6">
              <h2 className="text-2xl font-semibold mb-4 dark:text-white">Faction Cards</h2>
              <p className="dark:text-gray-300 mb-6">
                Explore the unique cards available to the {faction.name} faction.
              </p>
        ...
        <TabsContent value="lore">
          <Card className="dark:bg-gray-800 dark:border-gray-700">
            <CardContent className="pt-6">
              <h2 className="text-2xl font-semibold mb-4 dark:text-white">Faction Lore</h2>
              <div className="prose dark:prose-invert max-w-none">
                <p>
                  The {faction.name} emerged during the great cataclysm that reshaped the world. Their unique philosophy of {faction.philosophy.toLowerCase()} has guided their development and shaped their role in the ongoing conflict.
                </p>
                
                <p>
                  Known for their {faction.strength.toLowerCase()}, they have carved out a significant presence in the fractured world, using their technological advancements to secure resources and territory.
                </p>
                
                <p>
                  Their technology focuses on {faction.technology.toLowerCase()}, giving them a unique advantage in certain combat scenarios and making them a formidable force on the battlefield.
                </p>
              </div>
            </CardContent>
          </Card>
  ...
  return (
    <FeatureGate
      flag="useNewFactionUI"
      fallback={<LegacyFactionDetail />}
    >
