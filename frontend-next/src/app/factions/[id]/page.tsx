              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1">
                    ...
                    {faction.id === 'synthetic' && 'Technical, Adaptive'}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-1">
                    ...
                    {faction.id === 'synthetic' && '★★★☆☆ (Intermediate)'}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-1">
                    ...
                    {faction.id === 'synthetic' && 'Strong with Neuralis, weak against Aeonic'}
                  </p>
                </div>
              </div>
            </CardContent>
