  ...
  return (
    <>
      <CardContent className="pt-6 space-y-8">
        <div>
          <h2 className="text-xl font-semibold mb-4 dark:text-white">Review Your Information</h2>
        ...
        <div>
          ...
          <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-3">
            ...
            <div>
              ...
              <dd className="mt-1 text-gray-900 dark:text-white">{formData.email}</dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="mt-1 text-gray-900 dark:text-white capitalize">{formData.experience}</dd>
            </div>
          </dl>
        </div>
        ...
        <div>
          ...
          <dl className="grid grid-cols-1 gap-y-3">
            <div>
              <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Selected Faction</dt>
              <dd className="mt-1 text-gray-900 dark:text-white">
                {getFactionName(formData.selectedFaction || '')}
              </dd>
            </div>
            <div>
              <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Reason for Selection</dt>
        ...
        <div>
          ...
          <dl className="grid grid-cols-1 gap-y-3">
            <div>
              <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Deck Name</dt>
              <dd className="mt-1 text-gray-900 dark:text-white">{formData.deckName}</dd>
            </div>
            <div>
              <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Deck Style</dt>
              <dd className="mt-1 text-gray-900 dark:text-white">
                {getDeckStyleName(formData.deckStyle)}
              </dd>
            </div>
            <div>
              <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Preferred Cards</dt>
              <dd className="mt-1">
            ...
            {formData.customRules && (
              <div>
                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Custom Rules</dt>
                <dd className="mt-1 text-gray-900 dark:text-white whitespace-pre-wrap">
